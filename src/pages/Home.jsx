...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#080c14] font-nunito selection:bg-[#4f8ef7] selection:text-white pb-24 text-white">
      ...
      {/* Hero Carousel */}
      <header className="relative w-full aspect-[16/10] md:aspect-video min-h-[300px] md:max-h-[550px] overflow-hidden bg-[#0a1020]">
        {isLoading ? (
          <div className="w-full h-full bg-[#0f1520] relative overflow-hidden"><Shimmer /></div>
        ) : (
        ...
        {!isLoading && heroItems.length > 0 && (
          <div className="absolute bottom-6 right-6 flex items-center gap-2 z-20">
            ...
            <button onClick={() => { if (transitioning) setHeroIdx(p => p + 1); }} className="text-white hover:text-[#4f8ef7] transition-colors">
